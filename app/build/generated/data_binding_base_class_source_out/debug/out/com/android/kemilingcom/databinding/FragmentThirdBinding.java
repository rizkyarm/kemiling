...
public final class FragmentThirdBinding implements ViewBinding {
  ...
  private FragmentThirdBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView recycleview3) {
  ...
  public static FragmentThirdBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentThirdBinding((FrameLayout) rootView, recycleview3);
    }
