...
public final class ActivityFullScreenImageBinding implements ViewBinding {
  ...
  private ActivityFullScreenImageBinding(@NonNull ConstraintLayout rootView,
  ...
  public static ActivityFullScreenImageBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.full_screen_image;
      ImageView fullScreenImage = ViewBindings.findChildViewById(rootView, id);
      if (fullScreenImage == null) {
        break missingId;
      }

      return new ActivityFullScreenImageBinding((ConstraintLayout) rootView, fullScreenImage);
    }
